...
try {
    ...
    assert_equal('Coding session', NotificationContentBuilder::push_notification_title([]), 'push_notification_title: a completely empty session still returns something, not a crash');
