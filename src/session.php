...
<div class="max-w-2xl mx-auto px-4 py-6 pb-44">
  ...
  <?php else: ?>
    <div id="session-info" class="mb-4 rounded-xl border border-slate-800 bg-slate-900/50 px-4 py-3">
      <?= TranscriptView::render_session_static_info_html($detail) ?>
    </div>
    ...
    <?php else: ?>
      ...
      <div id="history-list" class="flex flex-col gap-2">
        <?php foreach ($entries as $entry): ?>
          <?= TranscriptView::render_transcript_entry($entry) ?>
        <?php endforeach; ?>
      </div>
    <?php endif; ?>

    <div id="thinking-indicator" class="mt-4">
      <?= TranscriptView::render_thinking_indicator_html($detail) ?>
    </div>
    ...
    <div id="blocked-prompt-section" class="mt-4">
      <?= TranscriptView::render_blocked_prompt_section_html($detail, $csrfToken) ?>
    </div>
  <?php endif; ?>
...
<?php include __DIR__ . '/partials/compose-bar.php'; ?>
