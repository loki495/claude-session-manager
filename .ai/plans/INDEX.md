...
- 2026-09-01-sessioneer-rename | active | Rename "Claude Session Manager"/csm -> "Sessioneer" across the repo, GitHub, and external infra (traefik, homie, host config files) - Tasks 2+3 done+verified (a real live-app incident found+fixed along the way, see RESULT.md); Task 4 (GitHub/dir rename) next | updated 2026-09-01
