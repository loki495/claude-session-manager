...
- 2026-09-02-healthcheck-session-start-ci | done | Fixed live Claude permission-menu reconciliation and Codex 0.152.1 new-session detail compatibility; verified Claude create and assessed CI | updated 2026-09-02
- 2026-09-02-codex-remote-status-hooks | done | Feed Remote-owned Codex working/blocked/idle lifecycle into Sessioneer and show external-input guidance for prompts Sessioneer cannot answer; implementation, tests, and live hook install complete, pending Codex trust review | updated 2026-09-02
